          ...
          {filteredTeam.map((card, index) => (
            <div className="personal_card" key={index}>
              ...
              <div className="card-body">
                <img
                  src={card && card.image.length > 3 ? card.image : NoImage}
                  alt="hello world"
                />
                <div className="info-body">
                  ...
                  <div className="buttons_wrp">
                    {card.user_type === "mentor" ? (
                      <button
                        className="personal_button btn-2"
                        onClick={() => navigateToCV(card.user_id)}
                      >
                        View cv
                      </button>
                    ) : (
                      <>
                        <button
                          className="personal_button btn-1"
                          onClick={() =>
                            window.open(card.website_link, "_blank")
                          }
                        >
                          Website
                        </button>
